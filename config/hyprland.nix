    ...
    extraConfig =
      ...
      concatStrings [
        ''
          ...
          monitor=LVDS-1,preferred,0x1080,1
          ...
          bind = ${modifier}ALT,S,exec,steam
          bind = ${modifier}SHIFT,G,exec,godot4
          bind = ${modifier},T,exec,thunar
          bind = ${modifier},M,exec,spotify
          bind = ${modifier},Q,killactive,

          bind = ${modifier}ALT,P,exec,pavucontrol 
          ...
          bind = ${modifier}SHIFT,B,movetoworkspace,special:browse
          bind = ${modifier},B,togglespecialworkspace,browse
